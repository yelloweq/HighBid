<div class="bg-red-500 hover:cursor-pointer mb-4 flex w-3/4 h-64"
    hx-get="{{ route('auction.view', ['auction' => $auction]) }}"
    hx-target="main"
    hx-swap="outerHTML"
    hx-push-url="true"
    >
    <div class="rounded-md bg-yellow-400">
        <div class="auction-card__image w-auto h-auto max-h-full max-w-full overflow-hidden">
            <img src="https://i.ebayimg.com/thumbs/images/g/xGQAAOSwPsRlwlJA/s-l300.webp" alt="{{ $auction->title }}">
        </div>
    </div>
