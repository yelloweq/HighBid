...
<div class="relative align-middle justify-center items-center hidden md:flex" x-data="{ open: false }"
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 scale-95"
        ...
        class="absolute z-50 mt-2 translate-y-16 {{ $width }} rounded-md shadow-lg {{ $alignmentClasses }}"
