...
<div class="relative h-10 w-72 min-w-[200px]">
    ...
    <select {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge([
        'class' =>
            'peer text-white  dropdown-select h-full w-full  rounded-[7px] border border-blue-gray-200 border-t-transparent bg-gray-900 px-3 py-2.5 font-sans text-sm font-normal  transition-all placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-gray-900 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50',
    ]) !!}>
        {{ $slot }}
    </select>
    <label
