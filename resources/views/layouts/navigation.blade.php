<nav x-data="{ open: false }" class="bg-transparent sticky border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="sm:-my-px sm:ms-10 sm:flex h-full">
                        <x-nav-link :href="route('auction.create')" :active="request()->routeIs('auction.create')" hx-boost="false">
                            {{ __('Create Auction') }}
                        </x-nav-link>
                </div>
