            ...
            <div class="relative mx-4 mt-4 overflow-hidden text-white bg-gray-900 rounded-none bg-clip-border">
              ...
              <div class="flex flex-col items-center justify-between gap-4 md:flex-row">
                <div class="block w-full overflow-hidden md:w-max">
                  <nav>
                    <ul role="tablist" class="relative flex flex-row p-1 rounded-lg bg-blue-accent bg-opacity-60">
                      <li role="tab"
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="p-4 border-b border-blue-gray-50">
                      <div class="w-max">
                        <div
                          class="relative grid items-center px-2 py-1 font-sans text-xs font-bold text-green-200 uppercase rounded-md select-none whitespace-nowrap bg-green-500/50">
                  ...
                  <tr>
                    ...
                    <td class="p-4 border-b border-blue-gray-50">
                      <div class="w-max">
                        <div
                          class="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-blue-accent0/20 text-gray-100">
                  ...
                  <tr>
                    ...
                    <td class="p-4">
                      <div class="w-max">
                        <div
                          class="relative grid items-center px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-blue-accent text-gray-100">
                          <span class="">offline</span>
                        </div>
                      </div>
                    </td>
